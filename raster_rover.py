...
# Small original rover icon: inline SVG + SMIL animation (spinning wheels,
# a little bob like it's driving over a bump). No external asset, no binary
# blob — just markup, so it's copyright-safe and has zero dependencies.
ROVER_ICON_SVG = (
    '<svg class="rover-icon" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">'
    '<g>'
    '<animateTransform attributeName="transform" type="translate" '
    'values="0,0; 0,-3; 0,0; 0,0" dur="1.1s" repeatCount="indefinite"/>'
    '<rect x="2" y="5" width="28" height="20" rx="4" fill="none" stroke="#5ec9ff" stroke-width="2"/>'
    '<circle cx="16" cy="15" r="3.5" fill="#5ec9ff"/>'
    '<g stroke="#5ec9ff" stroke-width="2">'
    '<circle cx="3" cy="25" r="4" fill="#14161a"/>'
    '<circle cx="29" cy="25" r="4" fill="#14161a"/>'
    '</g>'
    '<g stroke="#5ec9ff" stroke-width="1.3">'
    '<line x1="3" y1="22" x2="3" y2="28">'
    '<animateTransform attributeName="transform" type="rotate" from="0 3 25" to="360 3 25" dur="0.5s" repeatCount="indefinite"/>'
    '</line>'
    '<line x1="29" y1="22" x2="29" y2="28">'
    '<animateTransform attributeName="transform" type="rotate" from="0 29 25" to="360 29 25" dur="0.5s" repeatCount="indefinite"/>'
    '</line>'
    '</g>'
    '</g>'
    '</svg>'
...
VIEWER_CSS = r"""
  ...
  * { box-sizing: border-box; }
  ...
  h1 { font-size: 19px; font-weight: 700; margin: 0; white-space: nowrap; display: flex; align-items: center; gap: 8px; }
  .rover-icon { width: 26px; height: 26px; flex-shrink: 0; }
...
<div class="app">
  <div class="topbar">
    <div class="title-group">
      <h1>__ROVER_ICON__ Raster Rover Exploration Viewer</h1>
...
def build_page_html(arr, crs_display, source_name, cmap_name, transform, crs_wkt):
    ...
    html = html.replace("__ROVER_ICON__", ROVER_ICON_SVG)
